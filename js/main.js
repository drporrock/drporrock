(function ($) {
  ...
  $('.back-to-top').click(function(){
    ...
    var divsFadeIn = $('.fadeIn');   //this selects the divs of class 'fade' (multiple)
    $(window).on('scroll', function() {   //this selects the window and attaches to the scroll event.  when scroll occurs, the inline function is called
        ...
        divsFadeIn.css({ //this changes the css of the divs from before (specifically margin-top and opacity
            // 'margin-top' : (st/1)+"px",
            'opacity' : st/70 - 1
        }); 
    });
